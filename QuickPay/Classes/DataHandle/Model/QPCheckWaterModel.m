...
@implementation QPCheckWaterModel

- (void)dealloc {
    self.checkWaterid = nil;
    self.arena_code = nil;
...
- (id)initWithDictionary:(NSDictionary*)params {
    self = [self init];
    if (self) {
        self.checkWaterid = [params valueForKey:MODEL_KEY_ID];
...
- (NSMutableDictionary *)toDictionary {
    ...
    [dic setValue:self.checkWaterid forKey:MODEL_KEY_ID];
