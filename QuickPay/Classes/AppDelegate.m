...
@property (nonatomic, strong) QPLoginViewController *loginViewController;
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.Claudeli.CLShare" in the application's documents directory.
