...
- (void)viewDidLoad {
    ...
    [self createRightBarItemByImageName:@"dianpu_bangzhu" target:self action:@selector(notClick:)];
...
- (void)notClick:(id)sender {
    ...
    [QPMoreAboutViewController registerLocalNotification:1];// 4秒后
}
...
+ (void)registerLocalNotification:(NSInteger)alertTime {
    ...
    // 通知参数
    NSDictionary *userDict = [NSDictionary dictionaryWithObject:@"你有一笔新的订单" forKey:@"key"];
