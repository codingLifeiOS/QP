...
static NSString * const kMacAddressUserDefaultsKey = @"58keychainMacAddress";

@implementation QPUtils
...
+ (NSString *)getDeviceIMEI {
    ...
    if (CurrentDeviceVersion >= 7.0) {
        ...
        NSString *macaddress = [QPUtils getItemFromUserDefaults:kMacAddressUserDefaultsKey];
        if (!macaddress) {
