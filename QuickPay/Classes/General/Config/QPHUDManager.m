...
static QPHUDManager* hudInstance = nil;

static MBProgressHUD *globalHUD = nil;

@interface QPHUDManager ()

@end

@implementation QPHUDManager

SYNTHESIZE_SINGLETON_FOR_CLASS_ARC(QPHUDManager)
...
- (void)showTipAlertViewWithText:(NSString *)message
{
    ...
    [[QPAlertView alertViewWithMessage:message] show];
}
                    ...
                    onView:(UIView *)view
{
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        HUD.customView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"58_crm_success_icon"]];
                     ...
                     close:(BOOL)isCanClose
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        imageView.image = [UIImage imageNamed:@"58_mis_progress_bg.png"];
        ...
        if (isCanClose) {
            ...
            line.image = [UIImage imageNamed:@"58_mis_progress_line_bg.png"];
            ...
            [closeButton setImage:[UIImage imageNamed:@"58_mis_progress_button_bg.png"] forState:UIControlStateNormal];
